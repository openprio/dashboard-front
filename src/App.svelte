...
<Router {url}>
  <div>
    <Route
      path="/intersections/:operation_day/:road_regulator_id/:intersection_id"
      let:params
    >
      <IntersectionPerLine
        operation_day={params.operation_day}
        road_regulator_id={params.road_regulator_id}
        intersection_id={params.intersection_id}
      />
    </Route>

    <Route
      path="/intersections/:operation_day/:road_regulator_id/:intersection_id/journeys/:data_owner_code/:line_planning_number/:direction"
      let:params
    >
      <IntersectionPerJourney
        operation_day={params.operation_day}
        road_regulator_id={params.road_regulator_id}
        intersection_id={params.intersection_id}
        data_owner_code={params.data_owner_code}
        line_planning_number={params.line_planning_number}
    ...
    <Route path="/journeys/:dated_journey_id" let:params>
      <JourneyDetails dated_journey_id={params.dated_journey_id}
      ></JourneyDetails>
    </Route>
