<div class="m-0 h-[100vh] flex items-center justify-center bg-gray-700">
    <div class="loader">
        <div class="train"></div>
        <div class="track">
            <span></span>
...
<style>
    ...
    .train {
        ...
        height: 6em;
        background:
                radial-gradient(circle at 20% 80%, lightgoldenrodyellow 0.6em, transparent 0.6em),
                radial-gradient(circle at 80% 80%, lightgoldenrodyellow 0.6em, transparent 0.6em),
                #bbb;
        border-radius: 1em;
        position: relative;
        left: 1em;
